...
class MedicoRepositoryTest {
    ...
    void seleccionarMedicoConEspecialidadEnFechaEscenario1() {
        ...
        var medico = registrarMedico("José", "jose@vollmed.com", "145208", Especialidad.CARDIOLOGIA);
        var paciente = registrarPaciente("Carlos", "carlos@email.com", "24630");
    ...
    @Test
    @DisplayName("deberia retornar un medico cuando realice la constulta en la base de datos para ese horario")
